...
export const Footer = () => {
    return (
            ...
            <div>&copy; 2019&minus;2021 CoMitra by <a href="https://github.com/Soumodip-Paul" className="text-decoration-none" target="_blank" rel="noreferrer" >Soumodip Paul</a></div>
            <div>Support Us
                ...
                <a href="https://github.com/Soumodip-Paul" className="px-2 text-decoration-none">Github</a>
